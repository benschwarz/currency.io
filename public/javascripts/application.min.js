...
window.addEventListener("orientationchange",detectOrientation);if(!navigator.onLine)$("#network-status").className="offline";Converter.update_currency_display();setTimeout(function(){Converter.update_currencies()},100);
